...
### 2. Trading Bot
- Deployed automated trading system built on custom strategy.
- Achieved **5%+ average monthly return** using live execution pipeline.

### 3. Invoice Matcher
- Automated reconciliation of invoices and bank statements.
- Reduced manual accounting work by **90%** for agriturismo business.
